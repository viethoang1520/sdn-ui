...
const getUserApplications = async () => {
  try {
    return await axiosClient.get('/application/me')
  } catch (error) {
    console.log(`Error at getUserApplications: ${error}`)
  }
}


export { getUserInformation, updateUserInformation, getUserPurchaseHistory, getUserActiveTickets, getUserApplications }